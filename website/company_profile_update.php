...
if(isset($_POST['update'])){
   ...
   $update_profile->execute([$name, $email, $company_id]);
   ...
   if(!empty($image)){
      ...
      if($image_size > 2000000){
         ...
         $update_image->execute([$image, $company_id]);
   ...
   if(!empty($previous_pass) || !empty($new_pass) || !empty($confirm_pass)){
      if($previous_pass != $old_pass){
         ...
         $update_password->execute([$confirm_pass, $company_id]);
...
<h1 class="title"> update <span>company</span> profile </h1>
...
<section class="update-profile-container">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <div class="flex-btn">
         ...
         <a href="company_page.php" class="option-btn">go back</a>
      </div>
   </form>
